<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="open-control-plane-horizontal-color(white).svg">
    <source media="(prefers-color-scheme: light)" srcset="opencontrolplane_logo.svg">
